  ...
  return (
    <div className="listing-details-one theme-details-one mt-130 lg-mt-100 pb-150 xl-pb-120">
      ...
      <div className="container">
        <CommonBanner style_3={true} title={""} location={""} price={""} extras={""} />
                ...
                <div className="accordion-item">
                  ...
                  <div id="collapseOneA" className="accordion-collapse collapse show">
                    <div className="accordion-body">
                      <p className="fs-20 lh-lg m0"> blabla blaa Risk management and compliance, when approached strategically, have the potential to go beyond mitigating threats and protecting a company’s operations &amp; reputation.They can actually generate value and create opportunities. </p>
                    </div>
                  </div>
                </div>
