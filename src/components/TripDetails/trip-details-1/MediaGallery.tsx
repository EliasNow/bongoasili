// another optimization 22.00 17 aug
// next/image handles the generation of srcSet automatically based on the width, height, and sizes props provided. 
// To properly set responsive images with next/image, you need to rely on the built-in features of the component without manually setting srcSet.
"use client";
                  ...
                  bigCarousel.map((carousel, index) => (
                    <div key={index} className={`carousel-item ${index === activeIndex ? "active" : ""}`}>
                      <Image
                        ...
                        width={800}
                        height={450}
                        sizes="(max-width: 1024px) 100vw, (min-width: 1025px) 800px"
