...
// src/data/home-data/MenuData.ts
// interface SubMenu {
//     link: string;
//     title: string;
//   }
...
//   // was at the top of og code and includes submenus
//   interface MenuItem {
//     id: number;
//     title: string;
//     class_name?: string;
...
// src/data/home-data/HeaderMenuData.ts
import { MenuItem } from "@/interfaces/Menu";

const header_menu_data: MenuItem[] = [
  {
    id: 1,
    has_dropdown: true,
    title: "Home",
...
export default header_menu_data;
