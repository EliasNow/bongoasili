...
import bongoLogo from "@/assets/images/logo/bongo_new.svg"
      ...
      <div className="footer-four position-relative z-1">
         <div className="container container-large">
                  ...
                  <div className="col-xxl-3 col-lg-4 mb-60">
                     <div className="footer-intro">
                        <div className="logo mb-20">
                           <Link href="/">
                              <Image src={bongoLogo} alt="" />
                           </Link>
                        </div>
                        {/* <p className="mb-30 xs-mb-20">Eindhoven, The Netherlands</p>
                        <p className="mb-30 xs-mb-20">Nyeri, Kenya</p> */}
                        <Link href="#" className="email tran3s mb-60 md-mb-30">info@bongoasili.com</Link>
            ...
            <div className="bottom-footer">
               <p className="m0 text-center fs-16">Copyright @2024 Bongo Asili Travel</p>
            </div>
         </div>
